...
class MultiWallFilter {
  static RoomMetrics process({
    ...
    if (rawPoints.length < 15) {
      return RoomMetrics(length: esp32Length, width: esp32Width, area: esp32Area, corners: rawPoints);
    }

    if (!isMultiWall) {
      // MODUS A: DEIN ORIGINALER 4-WAND-FILTER (Perzentil-Box)
      List<double> angles = [];
    ...
    // MODUS B: DEIN DICHTEGEWICHTETES POLYGON-MODELL
